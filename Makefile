...
install_libs:
	...
	@install -m 0644 swig/python/_yanshee_api.so output/libs

install_python:
	@mkdir -p output/python/
	@install -m 0644 swig/python/yanshee_api.py output/python/
	@install -m 0644 swig/python/_yanshee_api.so output/python/
