...
UBT_RC_T RobotMessageQueueGetNumMsgs(void *pQueue, int *piMsgNum)
{
...
UBT_RC_T RobotMessagePeek(void *pQueue, void *pMessage,
...
UBT_RC_T RobotMessageReceive(void *pQueue, void *pMessage,
...
UBT_RC_T RobotMessageSend(void *pQueue, void *pMessage, unsigned int uiSize,
...
UBT_RC_T RobotMessageQueueDelete(void *pQueue)
{
    ROBOT_MSGQ_t *pstMsgQ = pQueue;
...
UBT_RC_T RobotMessageQueueLimitGet(void *pQueue, unsigned int *puiQLimit)
{
    ROBOT_MSGQ_t *pstMsgQ = pQueue;
