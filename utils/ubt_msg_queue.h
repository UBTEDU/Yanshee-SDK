...
*/
#ifndef __UBT_MSG_QUEUE_H__
#define __UBT_MSG_QUEUE_H__
...
extern UBT_RC_T RobotMessagePeek(void *pQueue, void *pMessage,
...
extern UBT_RC_T RobotMessageQueueDelete(void *pQueue);
extern UBT_RC_T RobotMessageQueueGetNumMsgs(void *pQueue, int *piMsgNum);
extern UBT_RC_T RobotMessageQueueLimitGet(void *pQueue, unsigned int *puiQLimit);
extern UBT_RC_T RobotMessageReceive(void *pQueue, void *pMessage,
                                             unsigned int uiSize, unsigned int uiWait);
extern UBT_RC_T RobotMessageSend(void *pQueue, void *pMessage, unsigned int uiSize,
